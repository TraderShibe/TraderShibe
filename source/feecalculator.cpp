	...
	: QDialog()
{
	...
	ui.buyBtcLayout->addWidget(new ShibeSpinBoxPicker(ui.buyTotalBtc));
	ui.buyPriceLayout->addWidget(new ShibeSpinBoxPicker(ui.buyPrice));
	ui.sellPriceLayout->addWidget(new ShibeSpinBoxPicker(ui.sellPrice));
	ui.feeLayout->addWidget(new ShibeSpinBoxPicker(ui.feeValue));
	ui.totalPaidLayout->addWidget(new ShibeSpinBoxPicker(ui.totalPaid));
	ui.receivedLayout->addWidget(new ShibeSpinBoxPicker(ui.btcReceived));
...
{
	ShibeTranslator.translateUi(this);
	setWindowTitle(ShibeTr("FEE_CALCULATOR_TITLE","Calculator"));
