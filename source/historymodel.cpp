...
void HistoryModel::setHorizontalHeaderLabels(QStringList list)
{
	...
	typesLabels[1]=ShibeTr("LOG_SOLD","sold");
	typesLabels[2]=ShibeTr("LOG_BOUGHT","bought");
	typesLabels[3]=ShibeTr("LOG_FEE","fee");
	typesLabels[4]=ShibeTr("LOG_DEPOSIT","deposit");
	typesLabels[5]=ShibeTr("LOG_WITHDRAW","withdraw");
