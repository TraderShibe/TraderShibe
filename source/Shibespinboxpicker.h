...
#ifndef ShibeSPINBOXPICKER_H
#define ShibeSPINBOXPICKER_H

#include <QLabel>
class QDoubleSpinBox;
class QMouseEvent;

class ShibeSpinBoxPicker : public QLabel
{
	Q_OBJECT

public:
	ShibeSpinBoxPicker(QDoubleSpinBox *parent, double *forceMinimumValue=0, double internalMinimumValue=0);
	~ShibeSpinBoxPicker();
