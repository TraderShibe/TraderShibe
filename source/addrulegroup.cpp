	...
	: QDialog(parent)
{
	...
	existingGroups.sort();
	ui.groupName->setText(ShibeTr("RULE_GROUP","Group"));
	...
	setWindowTitle(ShibeTranslator.translateButton("ADD_RULES_GROUP","Add Rules Group"));
...
void AddRuleGroup::on_ruleOpen_clicked()
{
	...
	QString fileName=QFileDialog::getOpenFileName(this, ShibeTr("OPEN_GOUP","Open Rules Group"),lastRulesDir,"(*.qbtrule)");
	if(fileName.isEmpty())
	{
