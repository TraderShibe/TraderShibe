...
ShibeSpinBoxPicker::ShibeSpinBoxPicker(QDoubleSpinBox *parent, double *forceMinValue, double intMinV)
	: QLabel()
{
...
ShibeSpinBoxPicker::~ShibeSpinBoxPicker()
{

}

void ShibeSpinBoxPicker::setIcon(int state)
{
...
void ShibeSpinBoxPicker::mousePressEvent(QMouseEvent *event)
{
	event->accept();
...
void ShibeSpinBoxPicker::mouseReleaseEvent(QMouseEvent *event)
{
	if(event->button()==Qt::LeftButton)
	{
		j_isPressing=false;
...
void ShibeSpinBoxPicker::mouseMoveEvent(QMouseEvent *event)
{
	if(j_isPressing)
	{
