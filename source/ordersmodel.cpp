...
void OrdersModel::setHorizontalHeaderLabels(QStringList list)
{
	...
	textAsk=ShibeTr("ORDER_TYPE_ASK","ask");
	textBid=ShibeTr("ORDER_TYPE_BID","bid");

	textStatusList[0]=ShibeTr("ORDER_STATE_CANCELED",textStatusList.at(0));
	textStatusList[1]=ShibeTr("ORDER_STATE_OPEN",textStatusList.at(1));
	textStatusList[2]=ShibeTr("ORDER_STATE_PENDING",textStatusList.at(2));
	textStatusList[3]=ShibeTr("ORDER_STATE_POST-PENDING",textStatusList.at(3));
	textStatusList[4]=ShibeTr("ORDER_STATE_INVALID",textStatusList.at(4));
